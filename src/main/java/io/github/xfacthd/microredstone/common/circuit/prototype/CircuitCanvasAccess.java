...
public interface CircuitCanvasAccess {
    @Nullable NodePos getNodePos(int mouseX, int mouseY);

    @Nullable ExactNodePos getExactNodePos(double mouseX, double mouseY);

    @Nullable PlaceableNode getPartNode(NodePos pos);
