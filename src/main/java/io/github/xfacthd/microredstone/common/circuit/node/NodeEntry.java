 ...
 */
public record NodeEntry<T extends CircuitNode>(T node, NodePos pos, WirePair[] inputs, WirePair[] outputs)
{
    ...
    public NodeEntry(T node, NodePos pos)
    {
        this(node, pos, EMPTY_ARRAY, EMPTY_ARRAY);
    }
