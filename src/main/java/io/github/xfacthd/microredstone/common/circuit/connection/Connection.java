...
public final class Connection implements PlaceableNode {
    public static final IconConfig ICON_SINGLE_IN = new IconConfig(Utils.id("part/connection_in"), Utils.id("port/right_single"), false);
    private static final IconConfig ICON_SINGLE_OUT = new IconConfig(Utils.id("part/connection_out"), Utils.id("port/right_single"), false);
    public static final IconConfig ICON_BUNDLED_IN = new IconConfig(Utils.id("part/connection_in"), Utils.id("port/right_bundled"), false);
    private static final IconConfig ICON_BUNDLED_OUT = new IconConfig(Utils.id("part/connection_out"), Utils.id("port/right_bundled"), false);
