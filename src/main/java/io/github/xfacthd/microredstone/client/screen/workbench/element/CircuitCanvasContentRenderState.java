...
public record CircuitCanvasContentRenderState(
    ...
    public static final Identifier WHITE_SPRITE = Utils.id("wire_white");
    ...
    private static @Nullable ScreenRectangle getBounds(int x, int y, @Nullable ScreenRectangle scissorArea) {
