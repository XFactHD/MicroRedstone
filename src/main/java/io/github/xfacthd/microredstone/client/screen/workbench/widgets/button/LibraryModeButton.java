...
public final class LibraryModeButton extends SimpleButton implements DropFocusAfterClick
{
    ...
    private final LibraryBrowser.Mode mode;

    public LibraryModeButton(LibraryBrowser owner, LibraryBrowser.Mode mode, int x, int y)
    {
