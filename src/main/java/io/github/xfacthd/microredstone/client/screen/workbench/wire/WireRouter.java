...
final class WireRouter {
    ...
    private static @Nullable WireNode computeNode(
            CircuitCanvas canvas,
            WireInProgress wip,
            NodePos startPos,
            NodePos endPos,
    ...
    private static @Nullable WireNode computeBacktrackedNode(CircuitCanvas canvas, NodePos startPos, NodePos endPos, Port dir) {
